...
const certs = [
  {
    ...
    year: '2024',
    accent: '#C6A969',
    logo: 'https://upload.wikimedia.org/wikipedia/en/thumb/4/4a/Sri_Lanka_Institute_of_Information_Technology_logo.png/120px-Sri_Lanka_Institute_of_Information_Technology_logo.png',
    fallbackText: 'SLIIT',
